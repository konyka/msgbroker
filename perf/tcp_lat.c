/*
    tcp_lat.c — TCP one-way latency benchmark (PUSH/PULL)
    Measures per-message latency over TCP loopback.
*/
...
#define TCP_ADDR    "tcp://127.0.0.1:9902"
...
int main (void)
{
    ...
    printf ("tcp latency: %d messages of %d bytes (round-trip PAIR)\n",
            MSG_COUNT, MSG_SIZE);
