/*
    inproc_thr.c — In-process throughput benchmark (PAIR socket)
    Measures messages/sec and MB/sec for in-process communication.
*/
...
int main (void)
{
    ...
    mb_bind (s1, "inproc://thr");
    mb_connect (s2, "inproc://thr");
    ...
    printf ("inproc throughput: %d messages of %d bytes\n", MSG_COUNT, MSG_SIZE);
